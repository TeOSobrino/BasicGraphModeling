...
BINARY = ./main
PROG = main.c
DFLAGS = -g3 -O2 -fsanitize=address -fstack-protector-all -fstack-clash-protection -fasynchronous-unwind-tables -D_FORTIFY_SOURCE=2
...
zip:
	zip -r T4.zip main.c include source makefile
clean:
	rm $(BINARY); rm *.zip
clear:
	clear
